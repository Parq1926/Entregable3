...
CREATE TABLE `cajero` (
  ...
  `Estado` enum('Activo','Fuera de Servicio','Mantenimiento') NOT NULL,
  `Monto` decimal(12,2) NOT NULL,
  PRIMARY KEY (`IdCajero`),
  UNIQUE KEY `Codigo_Cajero` (`Codigo_Cajero`)
...
INSERT INTO `cajero` VALUES (1,'CJ-001','Activo',5000000.00),(2,'CJ-002','Mantenimiento',2000000.00),(3,'CJ-003','Fuera de Servicio',0.00),(4,'CAJERO01','Activo',5000000.00);
